	...
	<body>
		...
		<div class="container theme-showcase" role="main">
			...
			<font face="verdana" size="2">
				A trav&eacute;s de esta herramienta se puede hacer un rastreo de la fecha de salida, puertos intermedios con fecha de arribo y zarpe, así como la fecha de descargue final del buque que lleva el contenedor del cliente. Escriba el n&uacute;mero del BL en el cuadro de texto.
			</font>	
			</div>
			<form class="form-horizontal" name="formcontato" method="POST" action="<?php echo "consultabl2.php?cod=$cod&u=$u";?>">
            ...
            <div class="form-group">
				...
				<tr>
					<td width="30%" align="right">
						...
						<h3><span class='glyphicon glyphicon-search text-dark' aria-hidden='true'></span>&nbsp;BL:</h3>
					</label>
					</td>
					<td width="70%">
						<div class="col-sm-5">&nbsp;
