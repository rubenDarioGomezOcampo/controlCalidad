...
<?php
	...
	$mbl = mysqli_real_escape_string($conectar, $_POST['mbl']);
	$pol = mysqli_real_escape_string($conectar, $_POST['pol']);
	$pod = mysqli_real_escape_string($conectar, $_POST['pod']);
	$tipo_contenedor = mysqli_real_escape_string($conectar, $_POST['tipo']);
	$size = mysqli_real_escape_string($conectar, $_POST['size']);
	$agente = mysqli_real_escape_string($conectar, $_POST['agente']);
	$fecha_hoy= date("Y-m-d H:i:s");
	$fecha_bl = mysqli_real_escape_string($conectar, $fecha_hoy);
	$id_cliente= mysqli_real_escape_string($conectar, $_POST['id_cliente']);
	$eta='0000-00-00';
	
	$result = "INSERT INTO bl(id_bl,id_mbl,id_cliente_bl,id_puerto_origen_bl,id_puerto_destino_bl,tipo_contenedor_bl,size,id_agente_carga_bl,fecha_registro_bl,eta_bl,id_usuario_registra,id_estadobl_bl) VALUES ('$bl','$mbl','$id_cliente', '$pol', '$pod', '$tipo_contenedor', '$size', '$agente','$fecha_bl','$eta','$u','1')";
	...
	if(!mysqli_error($conectar)){
		echo "<div class='alert alert-success' role='alert'>";
			...
			echo "&nbsp;&nbsp;<b>SE INGRESÓ EL NUEVO BL ".$bl." CORRECTAMENTE A LA BASE DE DATOS</b></div>";		
		}
			...
			echo " &nbsp;&nbsp;<b>NO SE PUDO AGREGAR EL BL $bl</b> <br>";
